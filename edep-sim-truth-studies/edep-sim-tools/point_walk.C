/*
Adapted from GitHub duneggd repo:

https://github.com/DUNE/duneggd/blob/69ed7dea263bd70403f5e28e2ec19fbf3b932e12/root/PointWalk.C
*/
...
void point_walk(double  x=0, double  y=10000, double  z=11402.9,
...
/*                 double px=0, double py=-1, double pz=0, */
		...
		std::string fname="../../input-root-files/EDEP-SIM/MicroProdN3p4_NDLAr_2E18_FHC.edep.nu.0000001.EDEPSIM.root",
                bool dumpRot=false,
                bool printDs=true,
                bool printMed=true,
                bool printMom=true,
                bool stripNum=true)
{
  ...
  TGeoManager::Import(fname.c_str(),"EDepSimGeometry");
